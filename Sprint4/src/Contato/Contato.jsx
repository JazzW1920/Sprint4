...
function ContactForm() {
  ...
  function buscarEndereco() {
    ...
    // URL da API de consulta de CEP (use a API de sua escolha)
    var url = `https://viacep.com.br/ws/${cep}/json/`;

    // Fazendo a solicitação HTTP GET para a API usando fetch
    fetch(url)
      .then(response => {
        if (!response.ok) {
          throw new Error(`Erro ao obter informações. Código de status: ${response.status}`);
        }
        return response.json();
      })
      .then(data => {
        // Verifica se a resposta contém informações de endereço
        if (data.erro) {
          alert("CEP não encontrado.");
        } else {
          // Preenche os campos de bairro, rua e cidade
    ...
    <div>
            ...
            <div className="card">
              ...
              <div className="form">
                ...
                <div className="group">
                  ...
                  <input type="text" id="cepInput" placeholder="Digite o CEP" onBlur={buscarEndereco}
                ...
                <div className="group">
                  ...
                  <input type="text" id="ruaInput" readonly/>
                </div>
      ...
      {submittedData && (
        <div className="alert alert-success mt-3">
          ...
          <div>
            <h3>Se algum dado foi enviado incorretamente:</h3>
